...
Thus the reader parameters accepted are a list of names from the following
list: 

  'BxBx', 'BxBy', 'BxBz', 'ByBy', 'ByBz', 'BzBz',
  'ExEx', 'ExEy', 'ExEz', 'EyEy', 'EyEz', 'EzEz',
  'BxEx', 'BxEy', 'BxEz', 'ByEx', 'ByEy', 'ByEz', 
  'BzEx', 'BzEy', 'BzEz' 
  
and the optional word:

  'complex'

Here there is an implicit '*' after the second component to indicate complex
conjugate.  
